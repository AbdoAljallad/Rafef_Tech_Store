...
export const creativeJobStatusSchema = z.enum(['draft', 'pending', 'in_progress', 'completed', 'cancelled']);
...
export const jobCreateSchema = z.object({
    jobTypeId: id.optional().nullable(),
...
export const statusChangeSchema = z.object({ toStatus: creativeJobStatusSchema, notes: z.string().optional().nullable() });
