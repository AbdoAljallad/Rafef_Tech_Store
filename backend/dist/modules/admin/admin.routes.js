...
router.get('/admin/users/:userId', requirePermission('auth.users.view'), asyncHandler(async (req, res) => {
    res.json({ user: await admin.user(userIdSchema.parse(req.params.userId)) });
}));
router.post('/admin/users', requirePermission('auth.users.manage'), asyncHandler(async (req, res) => {
...
router.patch('/admin/users/:userId', requirePermission('auth.users.manage'), asyncHandler(async (req, res) => {
...
router.delete('/admin/users/:userId', requirePermission('auth.users.manage'), asyncHandler(async (req, res) => {
...
router.put('/admin/users/:userId/permissions', requirePermission('auth.permissions.manage'), asyncHandler(async (req, res) => {
...
router.post('/admin/users/:userId/permissions/reset', requirePermission('auth.permissions.manage'), asyncHandler(async (req, res) => {
