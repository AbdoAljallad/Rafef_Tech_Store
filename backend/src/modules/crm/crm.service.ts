...
export class CrmService {
  ...
  async listCustomers(params: { search?: string; offset: number; limit: number; sort?: CustomerSortMode; language?: UiLanguage }) {
  ...
  async getCustomer(id: number, language?: UiLanguage) {
  ...
  async createCustomer(input: CustomerCreateInput, actorUserId: number, ipAddress?: string | null, language?: UiLanguage) {
  ...
  async updateCustomer(id: number, input: CustomerUpdateInput, actorUserId: number, ipAddress?: string | null, language?: UiLanguage) {
  ...
  async deleteCustomer(id: number, actorUserId: number, ipAddress?: string | null, language?: UiLanguage) {
    const before = await this.getCustomer(id, language);
  ...
  async createContact(customerId: number, input: ContactCreateInput, language?: UiLanguage) {
    await this.getCustomer(customerId, language);
    return this.crmRepository.createContact(customerId, input);
  }

  async createLocation(customerId: number, input: LocationCreateInput, language?: UiLanguage) {
    await this.getCustomer(customerId, language);
    return this.crmRepository.createLocation(customerId, input);
  }

  async createNote(customerId: number, input: NoteCreateInput, actorUserId: number, language?: UiLanguage) {
    await this.getCustomer(customerId, language);
